'use strict';
	...
	import { parse, simplify, simplifyConstant, expression } from 'mathjs';

	const { ConstantNode, FunctionNode, OperatorNode, SymbolNode } = expression.node;
...
export function factory(type, config, load, typed) {
	...
	var simplifyConstant = math.simplifyConstant;
